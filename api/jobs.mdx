...
sidebarTitle: "Jobs"
description: "Three endpoints manage job listings: GET /api/jobs returns all listings, GET /api/jobs/:id returns one, and POST /api/jobs creates a new listing for empresa accounts."
---
...
Returns every job listing in the database, ordered by `id` ascending.
